...
A simple Python + GitHub Actions starter project for generating a daily financial and geopolitical briefing.

## What this does
- Pulls recent market news from Finnhub.
...
## Next upgrades
- Add indices, oil, FX, crypto and UK gilt data.
- Add better summarisation logic.
- Email or Teams/Slack delivery.
